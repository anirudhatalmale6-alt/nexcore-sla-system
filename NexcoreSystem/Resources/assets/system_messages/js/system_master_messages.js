 ...
 * Version:       1.0
 * Location:      /public/nexcore/system_messages/js/system_master_messages.js
 *
 * Dependencies:
 *   - SweetAlert2 v11 JS (must be loaded BEFORE this file)
 *   - system_master_messages.css (must be loaded in the <head>)
 *
 * Available Methods:
 ...
 *   On load, the system checks the component images folder first:
 *     /public/nexcore/system_messages/images/nexcore-icon.png
 *   If the icon is found there, it uses the component version.
 *   If not found, it falls back to the central branding folder:
 *     /public/nexcore/branding/nexcore-icon.png
 *   This allows per-component icon overrides while keeping
 *   a clean central brand default.
 *
 * Quick Start:
 *   1. Load SweetAlert2 CSS + JS from CDN
 *   2. Load nxalert.css
 *   3. Load nxalert.js (this file)
...
var NxAlert = {
    ...
    /* Path to the component-level images folder (checked first) */
    _componentImages: '/public/nexcore/system_messages/images/',
    ...
    /* Resolved logo path - defaults to branding, upgraded if component icon exists */
